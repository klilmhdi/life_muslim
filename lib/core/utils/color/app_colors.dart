...
class AppThemeColor {
  ...
  AppThemeColor({required this.colorScheme});

  // Light Theme
  factory AppThemeColor.lightTheme() => AppThemeColor(
        colorScheme: ColorScheme(
          brightness: Brightness.light,
          primary: AppConsts.basicAppColor,
          onPrimary: Colors.white,
          primaryContainer: AppConsts.secondaryAppColor.withOpacity(0.2),
          onPrimaryContainer: AppConsts.basicAppColor,
          secondary: AppConsts.secondaryAppColor,
          onSecondary: Colors.white,
          secondaryContainer: AppConsts.secondaryAppColor.withOpacity(0.2),
          onSecondaryContainer: AppConsts.secondaryAppColor,
          ...
          onErrorContainer: Colors.red[700]!,
          ...
          inversePrimary: AppConsts.basicAppColor.withOpacity(0.8),
          surfaceTint: AppConsts.basicAppColor.withOpacity(0.1),
        ),
      );

  // Dark Theme
  factory AppThemeColor.darkTheme() => AppThemeColor(
          colorScheme: ColorScheme(
        brightness: Brightness.dark,
        primary: AppConsts.basicDarkAppColor,
        onPrimary: Colors.white,
        primaryContainer: AppConsts.secondaryDarkAppColor.withOpacity(0.2),
        onPrimaryContainer: Colors.white,
        secondary: AppConsts.secondaryDarkAppColor,
        onSecondary: Colors.white,
        secondaryContainer: AppConsts.secondaryDarkAppColor.withOpacity(0.2),
        onSecondaryContainer: AppConsts.secondaryDarkAppColor,
        tertiary: Colors.amber[200]!,
        onTertiary: Colors.black,
        tertiaryContainer: Colors.amber[800]!,
        onTertiaryContainer: Colors.amber[200]!,
        ...
        inversePrimary: AppConsts.basicDarkAppColor.withOpacity(0.3),
        surfaceTint: AppConsts.basicDarkAppColor.withOpacity(0.1),
      ));

  static List<ColorScheme> availableColorSchemes = [
    AppThemeColor.lightTheme().colorScheme,
    AppThemeColor.darkTheme().colorScheme,
  ];
...
//           onErrorContainer: Colors.white,
//           background: const Color(0xFF040D12),
...
//           scrim: const Color(0xFF040D12).withOpacity(0.5),
