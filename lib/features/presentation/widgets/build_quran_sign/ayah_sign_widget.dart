...
Widget ayahSign(context, String ayahNumber) => Stack(
      ...
      children: [
        ...
        SvgPicture.asset(AppAssets.ayahNumberSignIcon, height: 40.h, width: 40.w),
        Text(
          ayahNumber,
          textDirection: TextDirection.rtl,
          style: TextStyle(
            fontSize:
                MediaQuery.orientationOf(context) == Orientation.portrait ? AppConsts.font12size : AppConsts.font8size,
