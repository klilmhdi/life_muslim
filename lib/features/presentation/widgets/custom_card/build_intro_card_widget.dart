...
//   }
//
//   Widget _buildPortraitLayout(LocationState state, bool isPortrait) =>
//       Column(
//         children: [
//           const Spacer(flex: 1),
...
//                                   ])),
//                               IconButton(
//                                   onPressed: () => context.read<LocationBloc>().add(FetchCurrentLocationEvent()),
//                                   icon: Icon(
...
//             ),
//           ),
//           if (state is LocationLoading) ...[const LinearProgressIndicator()] else
...
//       );
//
//   Widget _buildLandscapeLayout(LocationState state, bool isPortrait) =>
